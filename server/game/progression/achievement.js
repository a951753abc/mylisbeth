...
const ACHIEVEMENTS = [
  ...
  // Season 6: 經濟改革 — NPC 任務
  {
    id: "first_mission",
    name: "初めての委託",
    nameCn: "第一次委託",
    desc: "完成 NPC 自主任務 1 次",
    check: (user) => (user.stats?.totalMissionsCompleted || 0) >= 1,
    titleReward: "委託者",
  },
  {
    id: "mission_10",
    name: "委託の達人",
    nameCn: "委託達人",
    desc: "完成 NPC 自主任務 10 次",
    check: (user) => (user.stats?.totalMissionsCompleted || 0) >= 10,
    titleReward: null,
  },
  {
    id: "mission_50",
    name: "司令官",
    nameCn: "司令官",
    desc: "完成 NPC 自主任務 50 次",
    check: (user) => (user.stats?.totalMissionsCompleted || 0) >= 50,
    titleReward: "司令官",
  },
  {
    id: "escort_5",
    ...
    nameCn: "護衛隊長",
    desc: "完成護送任務 5 次",
    check: (user) => (user.stats?.totalEscortMissions || 0) >= 5,
    titleReward: "護衛隊長",
  },
  // Season 6: 經濟改革 — 佈告板
  {
    id: "first_market_sell",
    name: "初めての掲示板",
    nameCn: "佈告板初體驗",
    desc: "首次在佈告板成功賣出物品",
    check: (user) => (user.stats?.totalMarketSold || 0) >= 1,
    titleReward: "佈告板常客",
  },
  {
    id: "market_sell_10",
    ...
    nameCn: "佈告板常客",
    desc: "在佈告板賣出 10 次",
    check: (user) => (user.stats?.totalMarketSold || 0) >= 10,
    titleReward: null,
  },
  {
    id: "market_profit_5000",
    name: "大商人",
    nameCn: "大商人",
    desc: "透過佈告板累計收入 5000 Col",
    check: (user) => (user.stats?.totalMarketEarned || 0) >= 5000,
    titleReward: "大商人",
  },
  {
    id: "col_50000",
  ...
  },
  {
    ...
    nameCn: "鍛造熟練者",
    desc: "鍛造等級達到 5",
    check: (user) => (user.forgeLevel || 1) >= 5,
    titleReward: null,
  },
  {
    id: "mine_master",
    ...
    nameCn: "挖礦大師",
    desc: "挖礦等級達到 10（最高等級）",
    check: (user) => (user.mineLevel || 1) >= 10,
    titleReward: "大師鉱夫",
  },
  {
    id: "forge_master",
    ...
    nameCn: "傳奇鍛造師",
    desc: "鍛造等級達到 10（最高等級）",
    check: (user) => (user.forgeLevel || 1) >= 10,
    titleReward: "伝説の鍛冶師",
  },
  {
    id: "battle_level_10",
