...
const TITLE_EFFECTS = {
  ...
  // 31. 大師鉱夫 — 挖礦大師（挖礦等級 10）
  "大師鉱夫": {
    mineStarChance: 0.30,       // 三星挖掘率 +30%
    staminaCost: -0.15,         // 體力消耗 -15%
    battleAtk: -0.15,           // 攻擊力 -15%
  },

  // 32. 伝説の鍛冶師 — 傳奇鍛造師（鍛造等級 10）
  "伝説の鍛冶師": {
    forgeBuffChance: 0.30,      // 強化成功率 +30%
    forgeDurability: 0.25,      // 初始耐久 +25%
    forgeCritSuccessAdj: -2,    // 大成功門檻 -2（更容易大成功）
    battleAtk: -0.25,           // 攻擊力 -25%
  },
